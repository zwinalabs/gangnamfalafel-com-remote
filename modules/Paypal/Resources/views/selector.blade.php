@if (
    ...
    <div class="custom-control custom-radio mb-3">
        <input name="paymentType" class="custom-control-input" id="paymentPayPal" type="radio" ontouchstart="mPaymentChoice('paypal')" onclick="mPaymentChoice('paypal')" value="paypal" {{ config('settings.default_payment')=="paypal"?"checked":""}}>
