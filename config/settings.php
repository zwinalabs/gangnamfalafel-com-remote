...
return [
    'front_languages'=>env('FRONT_LANGUAGES','EN,English,IT,Italian,FR,French'),
    ...
    'minimum_years_to_register' => env('MINIMUM_YEARS_TO_REGISTER', 12),
    ...
    'site_currency' => env('CASHIER_CURRENCY', 'eur'),
    ...
    'stripe_secret' => env('STRIPE_SECRET', 'sk_test_51MKTEqFlzyZwtAVRCktl6B5O58xTWGuz4r0osnWbkWTgukPNZIhvE4UxLAvtojrHlx360J2NpSdlksP5klIONcf60084ufu9eV'),
    'hide_cod' => env('HIDE_COD', false),
    'enable_stripe' => env('ENABLE_STRIPE', true),
    'stripe_key' => env('STRIPE_KEY', 'pk_test_51MKTEqFlzyZwtAVR07WlUkS8ZjjiK5PXjSmFgQJZnQkdo7OSTYNQz4SJmWP1dmokHplo4YrZAaeNcAlC9wNVv7ga003LFeRZfT'),
    ...
    'enable_stripe_connect' => env('ENABLE_STRIPE_CONNECT', true),
    'stripe_fee' => env('STRIPE_FEE', 1.5),
    'stripe_static_fee' => env('STRIPE_STATIC_FEE', 0.25),
    ...
    'admin_email' => env('ADMIN_EMAIL', 'contact@gobiz.tn'),
    ...
    'hideApps'=>env('HIDE_APPS_PANEL',true),
