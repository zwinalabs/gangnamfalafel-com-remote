...
window.onload = function () {
    ...
    const myTimeoutCheck = setTimeout(checkDineInTakeAway, 3000);
...
function checkDineInTakeAway(){
    let onsiteTakeAway = localStorage.getItem("onsiteTakeAway");
    if(onsiteTakeAway == "dinein"){
        $("#dineInTakewayChoice_dinein").show();
        $("#dineInTakewayChoice_takeaway").hide();
        $("#deliveryTypeDinein[type='radio']").attr("checked", true);
    }else if(onsiteTakeAway == "takeaway"){
        $("#deliveryTypeTakeAway[type='radio']").attr("checked", true);
