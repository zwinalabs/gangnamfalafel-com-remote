...
Route::get('/borne/{alias}', 'FrontEndController@borne')->name('vendorBorne');
...
Route::group(['middleware' => ['auth','impersonate']], function () {
    ...
    Route::name('admin.')->group(function () {
        ...
        Route::name('restaurant.')->group(function () {
            ...
            Route::get('removerestaurantgbz/{restaurant}', 'RestorantController@remove')->name('remove');
            // Tables
...
if (config('app.isqrsaas')) {
    ...
    Route::get('/cart-checkout-api', 'CartController@cartApiResponse')->name('cart.checkoutAPI');
}
...
Route::post('/cart-add-bulk', 'CartController@addBulk')->name('cart.addBulk');
...
Route::get('order/success-borne', 'OrderController@successBorne')->name('order.success.borne');
