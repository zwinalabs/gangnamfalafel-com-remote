<?php if(\Request::route()->getName() == "cart.checkout" ): ?>
    <?php
    $classMobileNavCheckout = "mobile-nav-checkout";
    ?>
<?php else: ?>
    <?php
        $classMobileNavCheckout = ""
    ?>
<?php endif; ?>

<nav id="navbar-main" class="navbar navbar-light navbar-expand-lg fixed-top <?php echo e($classMobileNavCheckout); ?>">
...
<?php /**PATH C:\laragon\www\gangnamfalafel-com\resources\views/layouts/menu/top_justlogo.blade.php ENDPATH**/ ?>