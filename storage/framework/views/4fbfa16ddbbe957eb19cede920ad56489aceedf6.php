...
<div class="row col-12  mb-2 mt-2 ">
    <div class="col-11 f-float-left">
        <input  id="coupon_code" name="coupon_code" type="text" class="form-control coupons-input" placeholder="<?php echo e(__('Discount coupon')); ?>">
    </div>
...
<div class="row col-12 mb-2">
    ...
    <div class="col-6 text-right"><button  id="btn-valid-comment" type="button" class="btn btn-outline-primary action-btn close"  onClick="setDiscountCoupon()"><?php echo e(__('Apply')); ?></button></div>
</div>

<?php /**PATH C:\laragon\www\gangnamfalafel-com\resources\views/cart/coupons.blade.php ENDPATH**/ ?>