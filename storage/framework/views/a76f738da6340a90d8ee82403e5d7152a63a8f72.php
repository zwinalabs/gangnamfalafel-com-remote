...
<div  id="cartListDetails" class="border-top pt-3">
    <div class="items col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix headed-div pl-0 p-10px">
        <div class="row m-r-0">
            <div class="col-7 text-center pl-0 pr-0"><?php echo e(__('Item')); ?></div>
            
            <div class="col-2 text-center pl-0 pr-0"><?php echo e(__('Quantity')); ?></div>
            <div class="col-3 text-center pl-0 pr-0"><?php echo e(__('Amount')); ?></div>
        </div>
    </div>
...
<div id="totalPricesCheckout" v-cloak>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col text-right">
                    <span v-if="itemsCount" class=""><strong><?php echo e(__('Total Price')); ?>:</strong></span>
    ...
    <div class="mb-6">
        <h6 class="mt-3 comment-title"><?php echo e(__('Comment')); ?><span class="font-weight-light"></span></h6>
        <textarea name="comment" id="cart-details-comment" class="green-border comment-field" placeholder="<?php echo e(__( 'Your comment here' )); ?> ..." onChange="setComments('cart-details-comment');" ></textarea>
    </div>
    <div class="text-center" v-if="itemsCount" v-cloak>
        <a href="javascript:void(0)" onClick="showCheckoutModel();"  class="btn btn-success mt-4 paymentbutton bg-gradient-red icon-shape callOutShoppingButtonBottomCheckout mb-1 go_pay_btn_bord hide-mobile-only"><?php echo e(__('Valider')); ?></a>
    </div>
</div>
<!-- End List of items -->
<?php /**PATH C:\laragon\www\gangnamfalafel-com\resources\views/cart/itemsdetails.blade.php ENDPATH**/ ?>