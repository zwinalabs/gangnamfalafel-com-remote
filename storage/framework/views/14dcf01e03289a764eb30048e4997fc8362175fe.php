                    ...
                    <div v-for="item in items" class="items col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
                        <div class="info-block block-info clearfix" v-cloak>
                            ...
                            <div class="row">
                                ...
                                <button :id="'cart-item-cart-trash-' + item.attributes.id" type="button" v-on:click="remove(item.id, item.attributes.id)"  :value="item.id" class="btn btn-outline-primary btn-icon btn-sm page-link btn-cart-radius">
                                ...
                                <button :id="'cart-item-cart-minus-' + item.attributes.id" type="button" v-on:click="decQuantity(item.id, item.attributes.id)" :value="item.id" class="btn btn-outline-primary btn-icon btn-sm page-link btn-cart-radius" style="display: none;">
                                ...
                                <button type="button" v-on:click="incQuantity(item.id, item.attributes.id)" :value="item.id" class="btn btn-outline-primary btn-icon btn-sm page-link btn-cart-radius">
...
<?php /**PATH C:\laragon\www\gangnamfalafel-com\resources\views/layouts/navbars/cartSideMenu.blade.php ENDPATH**/ ?>