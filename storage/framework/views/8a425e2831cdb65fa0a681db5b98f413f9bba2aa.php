    <div id="landing-page" style="background-image:linear-gradient(to bottom, rgba(245, 246, 252, 0.8), rgba(117, 19, 93, 0.12)), url(<?php echo e($restorant->coverm); ?>); display:<?php echo e((request()->get('dispalyCart'))?'none':'block'); ?>;">
        <!-- Circles background -->
    ...
    </div><?php /**PATH C:\laragon\www\gangnamfalafel-com\resources\views/restorants/partials/landingpage.blade.php ENDPATH**/ ?>