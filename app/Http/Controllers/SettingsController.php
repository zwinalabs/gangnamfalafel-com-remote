        ...
        if (auth()->user()->email !== 'admin@example.com') {
            ...
            if (config('mail.mailers.smtp.username') != '802fc656dd8029') {
                try {
                    ...
                    array_push($testResutls, ['settings_smtp', 'settings_smtp_not_ok', false, 'https://gobiz.tn/define-basics/obtain-smtp']);
                }
            } else {
                array_push($testResutls, ['settings_smtp', 'settings_smtp_not_ok', false, 'https://gobiz.tn/define-basics/obtain-smtp']);
            }
        } else {
            array_push($testResutls, ['settings_default_admin_email', 'settings_using_default_admin_solution', false, 'https://gobiz.tn/usage/getting-started#login-as-admin']);
        }
