...
class FrontEndController extends Controller
{
    ...
    public function borne($alias)
    {
        ...
        if ($restorant && $restorant->active == 1) {
           ...
           //$viewFile='restorants.borne';
           if($menuTemplate!='defaulttemplate'){
            $viewFile=config('settings.front_end_template','defaulttemplate')."::borne";
           }
           ...
           if(isset($_GET['tid'])){
            ...
            return abort(404,__('The selected restaurant borne is not active at this moment!'));
        }
    }
