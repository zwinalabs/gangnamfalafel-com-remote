...
class AppsController extends Controller
{
    public function index(){
        ...
        $protocols=$_SERVER['PROTOCOL'] = isset($_SERVER['HTTPS']) && !empty($_SERVER['HTTPS']) ? 'https' : 'http';
        //1. Get all available apps
        $appsLink="$protocols://$hosts/apps-gangnamfalafel/apps.json?version=".config('config.version');
