...
@section('content')
    ...
    <div class="container-fluid mt--7 mt-6"> 
                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-end flex-nowrap">
                        ...
                        <div class="col-sm-8 align-items-start">
                            <a  href="{{ $backUrl }}" type="button" class="btn btn-outline-primary btn-icon btn-sm page-link btn-cart-radius">
                        ...
                        <div class="col-sm-4" style=" display: flex; justify-content: flex-end">
                            <a  href="{{ url()->current() }}" type="button" class="btn btn-outline-primary btn-icon btn-sm page-link btn-cart-radius">
            ...
            <div class="col-xl-8 offset-xl-2">
                <div class="card bg-secondary shadow">
                    ...
                    @include('orders.partials.orderinfo')
                      <!-- WHATS APP Buttton -->
                      @if ($showWhatsApp)
                      <a target="_blank" href="{{ route('order.success')}}?order={{$order->id}}&whatsapp=yes"  class="btn btn-lg btn-icon btn btn-success mt-4 paymentbutton d-none">
