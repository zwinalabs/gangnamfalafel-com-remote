 <!-- qr_code_menu -->
 <section id="qrcodemenu" class="section section-lg pb-5 bg-soft">
    <div class="container">
        <div class="row">
            ...
            <a href="#" class="icon icon-lg text-gray mr-3">
                    <img style="width:300px" src="{{ asset('impactfront') }}/img/qrgangnamfalafel.jpg" />

            </a>
            <i class="fas fa-edit mr-2 text-primary ckedit_btn" type="button" style="display: none"></i>
            <p class="lead mb-5 ckedit" key="demo_subtitle" id="demo_subtitle">{{ __('qrlanding.demo_subtitle') . " " }}
                {{-- <span class="font-weight-bolder">{{ __('qrlanding.qr_code') }}</span> {{ __('qrlanding.below') }}! --}}
            </p> 
