<div class="card-profile">
    <div class="">
      {{--<div class="mt-5">
        <h6>{{ __('Payment') }}<span class="font-weight-light"></span></h6>
      </div> --}}
                    ...
                    <div class="modal-body p-0">                        
                        <div class="row col-12 dDFlex pr-0 pl-0  mr-0 ml-0">
                            ...
                            <div class="row col-12">
                                <div class="col-6"><button id="btn-cancel-dineintakeaway" type="button" class="btn btn-outline-primary action-btn close" data-dismiss="modal" aria-label="Close">{{ __('Cancel') }}</button></div>
                                <div class="col-6 text-right"><button  id="btn-valid-dineintakeaway" type="button" class="btn btn-outline-primary action-btn close" data-dismiss="modal" aria-label="Close">{{ __('Apply') }}</button></div>
                              </div>
                        </div>
                    </div>
                </div>
      ...
      <div  class="border-top pt-3">
        ...
        <div class="row mr-0 ml-0">
            <div class="col-12 dDFlex pr-0 pl-0">
                <h6 class="col-12 pr-0 pl-0 f-bolder">{{ __('Comment') }}</h6>
            </div>
            <div class="col-12 dDFlex pr-0 pl-0">
    ...
    {{-- 
        <div class="custom-control custom-radio mb-3">
                            ...
                            <label class="custom-control-label" for="paymentForceCache">{{ __('Passe paiement') }}</label>
                            <input name="forceCache" id="forceCache" type="text" class="form-control" placeholder="code passe paiement" value="">                        
                        </div>
    --}}
    ...
    <div  class="border-top pt-3">
                    ...
                    <div id="paymentChoiceNotSelected" class="col-12 pr-0 pl-0 f-size-15">
                        <span id="payementNotSelected" class="f-bolder" >
                            <a href="javascript:void(0)" onClick="$('#paymentsTypeModal').modal('show')" class="mody-checkout-link text-primary uppercase font-semibold text-xs leading-normal p-0">
                                ...
                                &nbsp;&nbsp;{{ __('Sélectionnez le mode de paiement') }}
                            </a>
                        </span>
                    </div>
                    <div class="col-12 dDFlex pr-0 pl-0 ">
                        <div class="col-6 pr-0 pl-0 f-size-15">
                            ...
                            <span id="paymentCache" class="f-bolder" style="display:none;"  >
                                ...
                                &nbsp;&nbsp;{{ config('app.isqrsaas')?__('Cash / Card Terminal'): __('Cash on delivery') }}
                            </span>
                        ...
                        <div class="col-6 pl-0 text-right">
                            <a id="linModifyPaymentMethod" href="javascript:void(0)" onClick="$('#paymentsTypeModal').modal('show')" class="mody-checkout-link text-primary uppercase font-semibold text-xs leading-normal pt-0"  style="display:none;"> {{ __('Modifier') }}</a>
                        </div>
                    </div>
            </div>
        </div>
        <div class="modal" id="paymentsTypeModal" tabindex="-1" role="dialog" aria-labelledby="paymentsTypeModal" aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="modalTitle" class="modal-title" id="modal-title-new-item">{{__("Online payments") }}</h5>
      ...
      <div  class="border-top pt-3">
            ...
            <div class="col-12 dDFlex pr-0 pl-0">
                <div class="col-12 p-4 text-center coupons-area">
                    <a href="javascript:void(0)" onClick="$('#couponsModal').modal('show')" class="mody-checkout-link text-primary uppercase font-semibold text-xs leading-normal">
                        ...
                        <span id="couponsLabel">{{ __('Ajouter un code de réduction') }}</span>
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mr-0 ml-0">
                            <div class="col pr-0 pl-0"><!----> 
                                <div class="col-12 dDFlex pr-0 pl-0">
                                    ...
                                    <div class="col-6 pl-0 text-right">
                                        <span class="ammount" id="itemsCountTotalPrice">{{ $itemsCountTotalPrice }}&nbsp;€</span>
                                    </div>
                                </div> <!----> 
                                <div class="col-12 dDFlex pr-0 pl-0">
                                    <div class="col-6 pr-0 pl-0">
                                    ...
                                    <div class="col-6 pl-0 text-right">
                                        <span class="ammount"><strong>{{ $itemsCountTotalPrice }}&nbsp;€</strong></span>
                                    </div></div> 
                                    <input type="hidden" id="tootalPricewithDeliveryRaw" value="{{ $itemsCountTotalPrice }}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body-fake">
                        <div class="row mr-0 ml-0">
                            <div class="col pr-0 pl-0">
                                ...
                                <div class="col-12 dDFlex pr-0 pl-0">
                                    <div class="col-6 pr-0 pl-0">
                                        <span v-if="itemsCount">{{ __('Subtotal') }}:</span>
                                    </div>
                                    <div class="col-6 pl-0 text-right">  
                                ...
                                <div class="col-12 dDFlex pr-0 pl-0">
                                    <div class="col-6 pr-0 pl-0 ">  
                                        <span v-if="itemsCount&&deliveryPrice>0">{{ __('Delivery') }}:</span>
                                    </div>
                                    <div class="col-6 pl-0 text-right"> 
        ...
        <div class="text-center">
            ...
            <span class="col-4">{{ __('Place order') }}</span>
